...
namespace Exiled.API.Features
{
    ...
    public static class Scp106Container
    {
        ...
        /// <summary>
        /// Gets or sets a <see cref="HashSet{T}"/> of <see cref="RoleTypeId"/> which contains all the roles ignored by LureSubjectContainer.
        /// </summary>
        public static List<RoleTypeId> IgnoredRoles { get; set; } = new() { RoleTypeId.Spectator };

...
#pragma warning disable SA1402
    ...
    /// </summary>
    internal static class StartingWarheadByCommand
    {
        /// <summary>
    ...
    ///     <see cref="Warhead.StartingWarhead" /> event when triggered by a command.
    /// </summary>
    ...
    internal static class StartingByDetonateCommand
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            StartingWarheadByCommand.InsertInstructions(index, generator, ref newInstructions);
